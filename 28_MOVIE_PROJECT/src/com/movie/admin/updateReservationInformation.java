...
public class updateReservationInformation {
    ...
    // 예매 정보 수정
    private static void updateReservationInformation() {
        try (Connection conn = DriverManager.getConnection(URL, USERNAME, PASSWORD);
             Scanner scanner = new Scanner(System.in)) {
    ...
    // 예매 정보 삭제
    private static void deleteReservationInformation() {
        try (Connection conn = DriverManager.getConnection(URL, USERNAME, PASSWORD);
             Scanner scanner = new Scanner(System.in)) {
